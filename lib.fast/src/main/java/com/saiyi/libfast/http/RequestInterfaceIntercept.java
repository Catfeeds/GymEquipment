 ...
 * 请求接口拦截器
 */
public class RequestInterfaceIntercept implements Interceptor {
     ...
     */
    public RequestInterfaceIntercept(List<String> requestMatchs) {
     ...
     * @param requestMatchs 请求接口过滤的正则
     */
    public RequestInterfaceIntercept(String... requestMatchs) {
    ...
    public static class Builder {
        ...
        public <T extends RequestInterfaceIntercept> T build() {
            return (T) new RequestInterfaceIntercept(requestMatchs);
        }
