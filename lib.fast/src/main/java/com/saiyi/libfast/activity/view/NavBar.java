package com.saiyi.libfast.activity.view;
...
public class NavBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void initView(Context context, AttributeSet attrs, View rootView) {
        ...
        leftTxtBtn = (Button) rootView.findViewById(R.id.left_txt_btn);
        ...
        leftTxtBtn.setOnClickListener(this);
        ...
        if (attrs != null) {
            ...
            /*左侧文字*/
            boolean showLeftTxt = typedArray.getBoolean(R.styleable.NavBar_showLeftText, false);
            leftTxtBtn.setVisibility(showLeftTxt ? View.VISIBLE : View.INVISIBLE);
            int leftTxtColor = typedArray.getColor(R.styleable.NavBar_leftTxtColor, getResources().getColor(R.color.navbar_title_color));
            leftTxtBtn.setTextColor(leftTxtColor);
            float leftSize = typedArray.getDimension(R.styleable.NavBar_leftTxtColor, getResources().getDimension(R.dimen.text_middle));
            leftTxtBtn.setTextSize(TypedValue.COMPLEX_UNIT_PX, leftSize);
            String leftTxt = typedArray.getString(R.styleable.NavBar_leftText);
            if (leftTxt != null) {
                leftTxtBtn.setText(leftTxt);
            }

            if (showLeftTxt) {
                leftTxtBtn.setVisibility(VISIBLE);
            }
    ...
    public void setLeftText(String txt) {
        ...
        leftTxtBtn.setText(txt);
    }

    public void setLeftTextSize(float size) {
        if (size > 0) {
            leftTxtBtn.setTextSize(TypedValue.COMPLEX_UNIT_PX, size);
        }
    }

    public void setLeftText(int titleId) {
        leftTxtBtn.setText(titleId);
    }

    public void setLeftTextColor(int color) {
        leftTxtBtn.setTextColor(color);
    }
    ...
    public void setLeftTextSize(int txtSize) {
        leftTxtBtn.setTextSize(txtSize);
    }

    public void setLeftTextPadding(int left, int top, int right, int bottom) {
        leftTxtBtn.setPadding(left, top, right, bottom);
    }

    public void hiddenLeftText() {
        leftTxtBtn.setVisibility(View.INVISIBLE);
    }

    public void showLeftText() {
        leftTxtBtn.setVisibility(View.VISIBLE);
    }
    ...
    public void onClick(View v) {
        ...
        } else if (vId == R.id.left_txt_btn) {
            mClickListener.onLeftTxtClick(v);
        }
    }
}
